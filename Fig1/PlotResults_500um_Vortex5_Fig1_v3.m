...
% 
% figure;
% imagesc(FluomapProj5,[0 1e-4]);
% colormap hot;
% colorbar
% 
% figure;
% imagesc(FluomapSubProj5,[0 1e-4]);
% colormap hot;
% colorbar

% figure;
% imagesc(log(FluomapProj0+eps),[-15 0]);
% colormap hot;
% colorbar 
% 
% figure;
% imagesc(log(FluomapProj5+eps),[-15 0]);
% colormap hot;
% colorbar
% 
% figure;
% imagesc(log(FluomapSubProj5+eps),[-15 0]);
% colormap hot;
% colorbar
...
% % Save as EMF
% exportgraphics(h0,'F0_Vortex5_v3.emf','ContentType','vector');
% Save as EMF Print
...
colormap hot;
% h_bar = colorbar;
% set(h_bar,'Ticks',[-14 0],'TickLabels',[ ],'Fontname','Calibri','FontWeight','bold','FontSize',10,'Position',[0.825 0.075 0.04 0.847]);
% h_bar.Label.String = 'Log(I_{norm})';
% h_bar.Label.FontSize = 10;
% h_bar.Label.Position = [1.4 -7 0];
set(gca,'XTickLabel',[]);
set(gca,'YTickLabel',[]);
...
% % Save as EMF
% exportgraphics(h1,'FB_Vortex5_v3.emf','ContentType','vector');
% Save as EMF Print
...
% h_bar = colorbar;
% set(h_bar,'Ticks',[-1e-5 1e-5],'TickLabels',[ ],'Fontname','Calibri','FontWeight','bold','FontSize',10,'Position',[0.825 0.075 0.04 0.847]);
...
% % Save as EMF
% exportgraphics(h2,'F0_Sub_Vortex5_v3.emf','ContentType','vector');
% Save as EMF Print
